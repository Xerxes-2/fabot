...
### Reclaim
The Task of claiming the sector Reactor for this player with CLAIM parts, pooled one per declared [[errand]] off the declaration alone, feeding-tier, and fired only on a tick the reactor is not ours — and not an [[ally]]'s while any Thorium is left in it. ADR-0057, ADR-0060, ADR-0069. ☢️
