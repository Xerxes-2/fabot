...
3. **The errand room's resident in peace is `Tuning.RangerResidentBlocks` blocks** (3), not one: the body a raid meets first. The row counts heads, so while the resident lives no raid-sized relief is cast; it holds alone until it dies, and the knob is what buys it time (at 7 it wins the two-longbow squad outright, for about 3.3 energy a tick).
